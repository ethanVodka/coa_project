...
import 'admin_home_drawer.dart';

class AdminDrawerUserController extends StatefulWidget {
  const AdminDrawerUserController({
    Key? key,
  ...
  final Function(DrawerIndexAdmin)? onDrawerCall;
  final Widget? screenView;
  final Function(bool)? drawerIsOpen;
  final AnimatedIconData? animatedIconData;
  final Widget? menuView;
  final DrawerIndexAdmin? screenIndex;

  @override
  AdminDrawerUserControllerState createState() => AdminDrawerUserControllerState();
}

class AdminDrawerUserControllerState extends State<AdminDrawerUserController> with TickerProviderStateMixin {
                  ...
                  builder: (BuildContext context, Widget? child) {
                    return Transform(
                      ...
                      child: AdminHomeDrawer(
                        screenIndex: widget.screenIndex ?? DrawerIndexAdmin.home,
                        iconAnimationController: iconAnimationController,
                        callBackIndex: (DrawerIndexAdmin indexType) {
                          onDrawerClick();
                          try {
                        ...
                        child: SizedBox(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              ...
                              child: Center(
                                child: widget.menuView ?? AnimatedIcon(color: isLightMode ? AppTheme.darkGrey : AppTheme.white, icon: widget.animatedIconData ?? AnimatedIcons.arrow_menu, progress: iconAnimationController!),
                              ),
                              onTap: () {
