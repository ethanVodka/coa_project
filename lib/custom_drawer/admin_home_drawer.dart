...
class AdminHomeDrawer extends StatefulWidget {
  const AdminHomeDrawer({Key? key, this.screenIndex, this.iconAnimationController, this.callBackIndex}) : super(key: key);

  final AnimationController? iconAnimationController;
  final DrawerIndexAdmin? screenIndex;
  final Function(DrawerIndexAdmin)? callBackIndex;

  @override
  AdminHomeDrawerState createState() => AdminHomeDrawerState();
}

class AdminHomeDrawerState extends State<AdminHomeDrawer> {
  List<DrawerListAdmin>? drawerList;
  @override
  void initState() {
    setDrawerListArray();
    super.initState();
  ...
  void setDrawerListArray() {
    drawerList = <DrawerListAdmin>[
      DrawerListAdmin(
        index: DrawerIndexAdmin.home,
        labelName: 'Home',
        icon: const Icon(Icons.home),
      ),
      DrawerListAdmin(
        index: DrawerIndexAdmin.manage,
        labelName: 'Managemant',
        icon: const Icon(Icons.calendar_month),
      ),
      DrawerListAdmin(
        index: DrawerIndexAdmin.account,
        labelName: 'Account',
  ...
  Widget inkwell(DrawerListAdmin listData) {
    return Material(
  ...
  Future<void> navigationtoScreen(DrawerIndexAdmin indexScreen) async {
    widget.callBackIndex!(indexScreen);
  }
}

enum DrawerIndexAdmin {
  home,
  account,
  manage,
}

class DrawerListAdmin {
  DrawerListAdmin({
